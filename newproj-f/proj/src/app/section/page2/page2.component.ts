...
export class Page2Component implements OnInit {
    ...
    ngOnInit() {
        ...
        this.newform = this.formBuilder.group({
            TA:[''],
            PN:[''],
            input1: ['19', Validators.required],
            input2: ['Asian/Oriental', Validators.required],
            ...
            input8: ['Abnormal', Validators.required],
            input9: ['5 to 12', Validators.required],
            input10: ['No', Validators.required],
            input11: ['Endoscopy surgery', Validators.required],
            input12: ['Anthrax', Validators.required],
            input13: ['Yes', Validators.required],
            input14: ['0.29', Validators.required],
            input15: ['Negative', Validators.required],
            input16: ['70-79%', Validators.required],
            input17: ['40', Validators.required],
            input18: ['7', Validators.required],
            input19: ['0.6', Validators.required],
            input20: ['135', Validators.required],
            input21: ['4.4', Validators.required],
            input22: ['1.3', Validators.required],
            input23: ['25', Validators.required],
            input24: ['25', Validators.required],
            input25: ['85', Validators.required],
            input26: ['51', Validators.required],
            input27: ['2', Validators.required],
            input28: ['12.2', Validators.required],
            input29: ['8.1', Validators.required],
            input30: ['5230', Validators.required],
            input31: ['111', Validators.required],
            input32: ['45', Validators.required],
            input33: ['2889', Validators.required],
            input34: ['662', Validators.required],
            input35: ['275', Validators.required],
            input36: ['99', Validators.required],
            input37: ['4.8', Validators.required],
            input38: ['38', Validators.required]
        });
    }
